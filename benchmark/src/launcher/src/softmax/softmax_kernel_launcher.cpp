...
const int softmax_kernel_BLOCK_SIZE = 64;


void softmax_kernel_wrap(uint32_t gridX, uint32_t gridY, uint32_t gridZ, int num_threads, softmax_kernel_kernel_ptr_t kernel_ptr , void* arg0, void* arg1, int32_t arg2, int32_t arg3, int32_t arg4) {
    // TODO: Consider using omp collapse(3) clause for simplicity?
    size_t N = gridX * gridY * gridZ;
    if (N == 1) {
        (*kernel_ptr)(arg0, arg1, arg2, arg3, arg4,  0, 0, 0, 1, 1, 1);
        return;
    }
